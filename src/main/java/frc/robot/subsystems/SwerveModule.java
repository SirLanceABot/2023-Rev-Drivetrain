...
class SwerveModule extends RobotDriveBase
{
    ...
    SwerveModule(SwerveModuleConfig smd)
    {
        ...
        driveMotor = new CANSparkMax(smd.driveMotorChannel, com.revrobotics.CANSparkMaxLowLevel.MotorType.kBrushless);
        ...
        turnMotor = new CANSparkMax(smd.turnMotorChannel, com.revrobotics.CANSparkMaxLowLevel.MotorType.kBrushless);
